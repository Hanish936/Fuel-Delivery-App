package com.example.fuels;//package com.example.fuels;
//
//
...
//            else {
//
//                Toast.makeText(location.this,"Please provide the required permission",Toast.LENGTH_LONG).show();
//
//            }
//
//
...
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(location.this, "go", Toast.LENGTH_SHORT).show();
//                Intent intent=new Intent(location.this,amount_of_fuel.class );
